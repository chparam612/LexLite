        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-xs space-y-3">
            <div className="flex items-center gap-2 text-slate-800 font-semibold text-sm">
              ...
              <h2 className="font-semibold text-slate-800 text-sm">Tenant Isolation & Defense</h2>
            </div>
            ...
            <div className="space-y-2 pt-1 text-xs">
              ...
              <div className="flex items-center justify-between p-2 rounded-lg bg-slate-50 border border-slate-100">
                ...
                <span className="text-[11px] font-bold text-emerald-700">Active (XML)</span>
              </div>
              <div className="flex items-center justify-between p-2 rounded-lg bg-slate-50 border border-slate-100">
                <span className="text-slate-700">Secret Scrubbing in Logs</span>
                <span className="text-[11px] font-bold text-emerald-700">Enforced</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-xs space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              <div className="p-3 bg-slate-50 rounded-lg border border-slate-100 space-y-1">
                <div className="text-slate-600 text-[11px]">Embedding Provider & Model</div>
              ...
              <div className="p-3 bg-slate-50 rounded-lg border border-slate-100 space-y-1">
                <div className="text-slate-600 text-[11px]">Generation LLM Model</div>
              ...
              <div className="p-3 bg-slate-50 rounded-lg border border-slate-100 space-y-1">
                <div className="text-slate-600 text-[11px]">Hybrid Fusion Strategy</div>
              ...
              <div className="p-3 bg-slate-50 rounded-lg border border-slate-100 space-y-1">
                <div className="text-slate-600 text-[11px]">Citation Verification Engine</div>
          ...
          <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-xs space-y-4">
            ...
            <div className="pt-2 flex justify-end">
              <button
                ...
                aria-label="Save platform preferences"

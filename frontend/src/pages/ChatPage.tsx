      ...
      <div className="w-80 flex flex-col bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden shrink-0">
        <div className="p-4 border-b border-slate-100 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-bold text-slate-800 text-sm">Research Sessions</span>
          </div>
          <button
        ...
        <div className="flex-1 overflow-y-auto p-3 space-y-1.5">
          {isLoading && (
            <div className="text-center py-8 text-xs text-slate-400">Loading sessions...</div>
          )}
        ...
        <div className="p-4 border-t border-slate-200 bg-slate-50/50">
          ...
          >
            <input
              ...
              disabled={isSending}
              className="flex-1 px-4 py-2.5 text-xs bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition disabled:bg-slate-100"
            />
            <button
              type="submit"
            ...
            <div className="mt-4 space-y-4 text-xs">
              <div className="bg-slate-50 p-3 rounded-lg border border-slate-100 space-y-1">
                ...
                <div className="text-slate-500 text-[11px] pt-1">
                  Page Number: <strong className="text-slate-700">{selectedCitation.page_number}</strong>
                </div>
              </div>
              ...
              <div className="pt-2">
                <div className="flex items-center gap-2 p-2.5 rounded-lg bg-emerald-50 border border-emerald-100 text-emerald-800 text-[11px]">
